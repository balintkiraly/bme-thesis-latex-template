...
xelatex: compile_xelatex
	mv $(DOCUMENT)-xelatex.pdf public/$(DOCUMENT).pdf
...
pdflatex: compile_pdflatex
	mv $(DOCUMENT)-pdflatex.pdf public/$(DOCUMENT).pdf
...
lualatex: compile_lualatex
	mv $(DOCUMENT)-lualatex.pdf public/$(DOCUMENT).pdf
...
test_hu:
	...
	mv $(DOCUMENT)-xelatex.pdf public/$(DOCUMENT)-xelatex-hu.pdf
	mv $(DOCUMENT)-pdflatex.pdf public/$(DOCUMENT)-pdflatex-hu.pdf
	mv $(DOCUMENT)-lualatex.pdf public/$(DOCUMENT)-lualatex-hu.pdf
...
test_en:
	...
	${MAKE} clean compile_pdflatex
	${MAKE} clean compile_lualatex
	mv $(DOCUMENT)-xelatex.pdf public/$(DOCUMENT)-xelatex-en.pdf
	mv $(DOCUMENT)-pdflatex.pdf public/$(DOCUMENT)-pdflatex-en.pdf
	mv $(DOCUMENT)-lualatex.pdf public/$(DOCUMENT)-lualatex-en.pdf
